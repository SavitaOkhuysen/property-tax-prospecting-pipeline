...
1. Scrapes commercial and industrial property data from three different municipal assessment systems (Vision Government Solutions, Patriot Properties, Avitar Associates) covering all 231 NH municipalities
2. Filters for properties with assessed values over $3M
3. Calculates full market value using real NH DRA equalization ratios
4. Incorporates the NH DRA 2023–2027 assessment review schedule to identify post-revaluation windows
5. Scores and ranks each property using a weighted model combining assessed value, equalization ratio, and appeal timing
6. Exports tiered prospecting lists ready for owner outreach
...
| Factor | Weight | Logic |
|--------|--------|-------|
| Combined value + ratio score | 50 points | Geometric mean of normalized assessment value and inverse ratio score |
| Assessment review timing | 30 points | Post-revaluation years get highest scores (appeal window is freshest) |
| Raw abatement opportunity | 20 points | Dollar size of the gap between assessed and full market value |
...
| Metric | Value |
|--------|-------|
| Municipalities covered | 231 (all of NH) |
| Properties analyzed | 1,200+ (live) / 561 (simulation) |
| Total assessed value | $5.2B |
| Tier A prospects | 30 |
| Tier A abatement opportunity | $47M |
...
| File | Contents | Use |
|------|----------|-----|
| nh_commercial_prospects_full.csv | All properties scored and ranked | Full pipeline review |
